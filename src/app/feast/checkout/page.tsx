...
import { CheckCircle, CreditCard, MapPin, Apple, Check, UtensilsCrossed, Award } from 'lucide-react';
...
export default function FeastCheckoutPage() {
    const { cartItems, getCartTotal, clearCart } = useFeastCart();
    ...
    const handlePlaceOrder = async () => {
        ...
        clearCart();
        router.push('/feast/order-tracking');
    }
    ...
    <div className="bg-background min-h-screen">
      <div className="container mx-auto max-w-lg px-4 py-8">
        <div className="flex items-center gap-3 mb-6">
           <Link href="/feast/cart" className="text-primary">
                    ...
                    {userProfile && (userProfile.inquePoints || 0) > 0 && (
                      <div className="flex justify-between items-center pt-2">
                         <div className="flex items-center gap-2">
                           ...
                           <Label htmlFor="apply-points-feast" className="font-semibold">
                              Apply {userProfile.inquePoints?.toFixed(0)} INQUE Points?
                           </Label>
                         </div>
                         <Switch
                           id="apply-points-feast"
                           checked={applyPoints}
