...
import { CheckCircle, CreditCard, MapPin, Apple, Check, HardDrive, Award } from 'lucide-react';
...
export default function VoltCheckoutPage() {
    const { cartItems, getCartTotal, clearCart } = useVoltCart();
    ...
    const handlePlaceOrder = async () => {
        ...
        toast({
            title: "Order Placed!",
            description: "Your Volt order has been successfully placed.",
        });
        router.push('/volt');
    }
    ...
    <div className="bg-background min-h-screen">
      <div className="container mx-auto max-w-lg px-4 py-8">
        <div className="flex items-center gap-3 mb-6">
           <Link href="/volt/cart" className="text-primary">
                     ...
                     {userProfile && (userProfile.inquePoints || 0) > 0 && (
                      <div className="flex justify-between items-center pt-2">
                         <div className="flex items-center gap-2">
                           ...
                           <Label htmlFor="apply-points-volt" className="font-semibold">
                              Apply {userProfile.inquePoints?.toFixed(0)} INQUE Points?
                           </Label>
                         </div>
                         <Switch
                           id="apply-points-volt"
                           checked={applyPoints}
